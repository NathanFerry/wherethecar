...
INSERT INTO vehicle (uuid, license_plate, manufacturer, model, energy, power, seats, capacity, utility_weight, color, kilometers, acquisition_date, status) VALUES
    ...
    ('44444444-4444-4444-4444-444444444444', 'JKL-012', 'Honda', 'Civic', 'hybrid', 143, 5, 420, 1300, 'blue', 35000, '2022-09-05 11:15:00', 'available'),
    ...
    ('66666666-6666-6666-6666-666666666666', 'PQR-678', 'Renault', 'Kangoo', 'diesel', 90, 2, 800, 1800, 'white', 64000, '2021-08-17 13:20:00', 'maintenance'),
